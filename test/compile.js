...
t('/test/official/conversions.wast', async function() { await ex(this.name, {spectest}) })
...
t('/test/official/f32_bitwise.wast', async function() { await ex(this.name, {spectest}) })
t('/test/official/f32_cmp.wast', async function() { await ex(this.name, {spectest}) })
t('/test/official/f32.wast', async function() { await ex(this.name, {spectest}) })
t('/test/official/f64_bitwise.wast', async function() { await ex(this.name, {spectest}) })
t('/test/official/f64_cmp.wast', async function() { await ex(this.name, {spectest}) })
t('/test/official/f64.wast', async function() { await ex(this.name, {spectest}) })
t('/test/official/fac.wast', async function() { await ex(this.name, {spectest}) })
t('/test/official/float_exprs.wast', async function() { await ex(this.name, {spectest}) })
...
t('/test/official/float_misc.wast', async function() { await ex(this.name, {spectest}) })
...
t('/test/official/i32.wast', async function() { await ex(this.name, {spectest}) })
t('/test/official/i64.wast', async function() { await ex(this.name, {spectest}) })
...
t('/test/official/memory_copy.wast', async function() { await ex(this.name, {spectest}) })
...
t('/test/official/table_copy.wast', async function() { await ex(this.name, {spectest}) })
