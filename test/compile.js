...
t('/test/official/memory_init.wast', async function () { await file(this.name, { spectest }) })
...
t('/test/official/memory_trap.wast', async function () { await file(this.name, { spectest }) })
