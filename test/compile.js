...
t('/test/example/fire.wat', async function () { await file(this.name, { '': {rand:Math.random} }) })
t('/test/example/snake.wat', async function () { await file(this.name, { Math }) })
t('/test/example/dino.wat', async function () { await file(this.name, { Math }) })
t('/test/example/raytrace.wat', async function () { await file(this.name, { Math }) })
t('/test/example/maze.wat', async function () { await file(this.name, { Math, env:{t(){}} }) })
t('/test/example/metaball.wat', async function () { await file(this.name, { '': {rand:Math.random}}) })
