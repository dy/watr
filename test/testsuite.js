...
// extensions
t('/test/official/proposals/annotations/annotations.wast', async function () { await file(this.name, { spectest }) })
t('/test/official/proposals/annotations/id.wast', async function () { await file(this.name, { spectest }) }) // TODO: requires quoted identifier support ($"")
t('/test/official/proposals/annotations/simd_lane.wast', async function () { await file(this.name, { spectest }) })
t('/test/official/proposals/annotations/token.wast', async function () { await file(this.name, { spectest }) })
...
t.mute('/test/official/proposals/gc/array_copy.wast', async function () { await file(this.name, { spectest }) })
...
t.mute('/test/official/proposals/gc/array.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/proposals/gc/binary-gc.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/proposals/gc/binary.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/proposals/gc/br_on_cast_fail.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/proposals/gc/br_on_cast.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/proposals/gc/br_on_non_null.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/proposals/gc/br_on_null.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/proposals/gc/br_table.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/proposals/gc/call_ref.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/proposals/gc/data.wast', async function () { await file(this.name, { spectest }) })
...
t.mute('/test/official/proposals/gc/struct.wast', async function () { await file(this.name, { spectest }) })
...
t.mute('/test/official/proposals/gc/unreached-invalid.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/proposals/gc/unreached-valid.wast', async function () { await file(this.name, { spectest }) })
