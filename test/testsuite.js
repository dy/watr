...
t('/test/official/f32.wast', async function () { await file(this.name, { spectest }) })
...
t.todo('/test/official/int_literals.wast', async function () { await file(this.name, { spectest }) })
...
t.todo('/test/official/memory.wast', async function () { await file(this.name, { spectest }) })
...
t.todo('/test/official/simd_lane.wast', async function () { await file(this.name, { spectest }) })
...
t.todo('/test/official/stack.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/start.wast', async function () { await file(this.name, { spectest }) })
...
t.todo('/test/official/table.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/token.wast', async function () { await file(this.name, { spectest }) })
...
t.todo('/test/official/utf8-invalid-encoding.wast', async function () { await file(this.name, { spectest }) })
...
t.only('/test/official/proposals/function-references/table.wast', async function () { await file(this.name, { spectest }) })
