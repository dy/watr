...
t.mute('/test/official/imports1.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/imports2.wast', async function () { await file(this.name, { spectest }) })
...
t.only('/test/official/inline-module.wast', async function () { await file(this.name, { spectest }) })
t.only('/test/official/instance.wast', async function () { await file(this.name, { spectest }) })
