...
t.todo('/test/official/address0.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/address1.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/address64.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/align.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/align0.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/align64.wast', async function () { await file(this.name, { spectest }) })
...
t.todo('/test/official/binary_leb128_64.wast', async function () { await file(this.name, { spectest }) })
...
t.todo('/test/official/bulk64.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/call_indirect.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/call_indirect64.wast', async function () { await file(this.name, { spectest }) })
...
t.todo('/test/official/data0.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/data1.wast', async function () { await file(this.name, { spectest }) })
...
t.todo('/test/official/endianness64.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/exports.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/exports0.wast', async function () { await file(this.name, { spectest }) })
...
t.todo('/test/official/float_exprs0.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/float_exprs1.wast', async function () { await file(this.name, { spectest }) })
...
t.todo('/test/official/float_memory0.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/float_memory64.wast', async function () { await file(this.name, { spectest }) })
...
t.todo('/test/official/id.wast', async function () { await file(this.name, { spectest }) })
...
t.todo('/test/official/imports0.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/imports1.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/imports2.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/imports3.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/imports4.wast', async function () { await file(this.name, { spectest }) })
...
t.todo('/test/official/linking0.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/linking1.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/linking2.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/linking3.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/load.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/load0.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/load1.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/load2.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/load64.wast', async function () { await file(this.name, { spectest }) })
...
t.todo('/test/official/memory_copy0.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/memory_copy1.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/memory_copy64.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/memory_fill.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/memory_fill0.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/memory_fill64.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/memory_grow.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/memory_grow64.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/memory_init.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/memory_init0.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/memory_init64.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/memory_redundancy.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/memory_redundancy64.wast', async function () { await file(this.name, { spectest }) })
...
t.todo('/test/official/memory_size0.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/memory_size1.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/memory_size2.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/memory_size3.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/memory_trap.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/memory_trap0.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/memory_trap1.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/memory_trap64.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/memory-multi.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/memory.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/memory64-imports.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/memory64.wast', async function () { await file(this.name, { spectest }) })
...
t.todo('/test/official/simd_memory-multi.wast', async function () { await file(this.name, { spectest }) })
...
t.todo('/test/official/start0.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/store.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/store0.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/store1.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/store2.wast', async function () { await file(this.name, { spectest }) })
...
t.todo('/test/official/table_copy_mixed.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/table_copy.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/table_copy64.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/table_fill.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/table_fill64.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/table_get.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/table_get64.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/table_grow.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/table_grow64.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/table_init.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/table_init64.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/table_set.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/table_set64.wast', async function () { await file(this.name, { spectest }) })
t.mute('/test/official/table_size.wast', async function () { await file(this.name, { spectest }) })
t.todo('/test/official/table_size64.wast', async function () { await file(this.name, { spectest }) })
...
t.todo('/test/official/table64.wast', async function () { await file(this.name, { spectest }) })
...
t.todo('/test/official/throw.wast', async function () { await file(this.name, { spectest }) })
...
t.todo('/test/official/traps0.wast', async function () { await file(this.name, { spectest }) })
