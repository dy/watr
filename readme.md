...
|---|---|---|---|
| **watr/optimize** | **20,490 B** | **91 ms** in-process | 115 KB min (35 KB gz) |
| `wasm-opt -Oz` | 19,852 B | 990 ms CLI | ~1.1 MB js / native binary |
| `wasm-opt -O3` | 22,302 B | — | — |

Smaller than `-O3` on every module; ties or beats `-Oz` on 13 of 20 (within 3.2% overall — the rest is branch-level liveness/RSE work).
