...
|---|---|---|---|
| **watr/optimize** | **20,486 B** | **93 ms** in-process | 117 KB min (36 KB gz) |
| `wasm-opt -Oz` | 19,852 B | 990 ms CLI | ~1.1 MB js / native binary |
| `wasm-opt -O3` | 22,302 B | — | — |

Smaller than `-O3` on every module; ties or beats `-Oz` on 13 of 20 (within 3.2% overall — the rest is instruction-selection-grade rewrites).
