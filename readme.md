# <img src="./watr.svg" height="16"> watr [![npm](https://img.shields.io/npm/v/watr?color=white)](https://npmjs.org/watr) [![test](https://github.com/dy/watr/actions/workflows/test.js.yml/badge.svg)](https://github.com/dy/watr/actions/workflows/test.js.yml) [![spec](https://github.com/dy/watr/actions/workflows/spec.yml/badge.svg)](https://github.com/dy/watr/actions/workflows/spec.yml)
...
with no process spawn, and a ~25× smaller footprint.</sup>
